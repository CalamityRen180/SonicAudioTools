...
A set of tools to modify CRIWARE file formats for Sonic The Hedgehog (2006).

## Building

If you still wish to build the solution yourself, do as follows:

1. Clone from [GitHub](https://github.com/CalamityRen180/SonicAudioTools.git) `git clone https://github.com/CalamityRen180/SonicAudioTools.git`
...
### [Sonic Audio Library](https://github.com/CalamityRen180/tree/master/Source/SonicAudioLib)

This is the main library of the solution. Contains classes for IO and file formats.

### [CSB Builder](https://github.com/CalamityRen180/tree/master/Source/CsbBuilder)
...
### [CSB Editor](https://github.com/CalamityRen180/tree/master/Source/CsbEditor)

This tool allows you to edit the audio content of a CSB file.  
It's a lot simpler to use than CSB Builder.
